...
export function StockTransferModal({ isOpen, onClose, onTransfer, product }: StockTransferModalProps) {
  ...
  return (
    <div className="fixed inset-0 bg-white/70 dark:bg-black/60 backdrop-blur-sm z-[9999] flex flex-col xl:items-center xl:justify-center p-4">
      <div className="bg-white dark:bg-neutral-950 rounded-none xl:rounded-2xl shadow-2xl w-full h-full xl:h-[calc(98vh-4rem)] xl:w-[calc(100vw-18rem)] xl:max-h-[calc(98vh-4rem)] xl:max-w-[calc(100vw-18rem)] overflow-hidden flex flex-col border-0 xl:border border-gray-200 dark:border-neutral-700 relative z-[10000]">
        ...
        <form onSubmit={(e) => { e.preventDefault(); handleTransfer() }} className="p-4 md:p-6">
          <div className="max-w-4xl mx-auto space-y-6">
                        ...
                        {(['warehouse', 'store'] as const).map((location) => {
                          ...
                          return (
                            <button
                              ...
                              className={`w-full p-4 rounded-lg border-2 transition-all ${
                                isDisabled
                                  ? 'border-gray-200 dark:border-neutral-700 text-gray-400 dark:text-gray-500 cursor-not-allowed opacity-50'
                                  : isSelected
                                  ? 'border-cyan-500 bg-cyan-50 dark:bg-cyan-900/20'
                                  : 'border-gray-300 dark:border-neutral-600 hover:border-gray-400 dark:hover:border-gray-500'
                              }`}
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className={`w-full px-3 py-2 border rounded-md focus:ring-2 focus:ring-cyan-500 focus:border-transparent text-gray-900 dark:text-white bg-white dark:bg-neutral-900 ${
                          errors.quantity ? 'border-red-500' : 'border-gray-300 dark:border-neutral-600'
                        }`}
            ...
            <Card className="bg-gray-50 dark:bg-neutral-900 border-gray-200 dark:border-neutral-700 mt-6">
              <CardHeader>
                <CardTitle className="text-lg text-gray-900 dark:text-white flex items-center">
              ...
              <CardContent>
                <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                  <div className="p-4 bg-white dark:bg-neutral-800/50 rounded-lg">
