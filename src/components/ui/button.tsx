  ...
  return (
    <button
      className={cn(
        ...
        {
          "bg-gray-600 text-white hover:bg-gray-700 dark:bg-neutral-700 dark:hover:bg-gray-700": variant === 'default',
          "bg-red-600 text-white hover:bg-red-700 dark:bg-red-600 dark:hover:bg-red-700": variant === 'destructive',
          "border-2 border-gray-300 dark:border-neutral-600 bg-white dark:bg-neutral-900 text-gray-900 dark:text-white hover:bg-gray-50 dark:hover:bg-gray-700": variant === 'outline',
          "bg-gray-100 dark:bg-neutral-800 text-gray-900 dark:text-white hover:bg-gray-200 dark:hover:bg-neutral-700": variant === 'secondary',
