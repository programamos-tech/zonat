  ...
  return (
    <button
      className={cn(
        ...
        variant === 'default' &&
          'rounded-lg border border-zinc-200/90 bg-zinc-100 text-zinc-900 shadow-none hover:border-zinc-300/80 hover:bg-white dark:border-zinc-300/50 dark:bg-zinc-100 dark:text-zinc-950 dark:hover:border-zinc-200/80 dark:hover:bg-white',
        variant === 'destructive' &&
